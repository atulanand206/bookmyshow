...
public class UpdateUserDto {
   ...
   * @throws IllegalArgumentException in any of the following fails to be conformant: 1. Phone
   *     number : Must be 10 characters in length and all numeric. 2. Email : Must contain @ in the
